    ...
    <section id="hero" className="relative min-h-screen flex items-center pt-6 md:pt-14">
      ...
      <div className="container mx-auto px-4 z-10 py-4 md:py-8">
        <div className="max-w-3xl mx-auto text-center">
          {/* CTA Buttons - increased margin-top to move them down */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-36 animate-fade-up" style={{ animationDelay: '0.4s' }}>
            <a 
